                ...
                <div className="row">
                    <div className="col-md-5 col-sm-12 left-block">
                        ...
                        <div className=" text-div ">
                            ...
                            <Link to='/signinform'><button className="btn btn-light sign-btn">SIGN IN</button></Link>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <div className="text-center">
                                    <div>
                                        <p className="small-font mt-1">Already have an account?<span className='text-primary btn btn-sm py-0'> <Link to='/signinform'>Log in</Link></span></p>
                                    </div>
                                    <div>
